            ...
            <div class="sidebar-nav">
                <div class="nav-canvas">
                    ...
                    <ul class="nav nav-pills nav-stacked main-menu">
                        ...
                        <li class="accordion">
                            <a href="/bus/index"><i class="glyphicon glyphicon-plus"></i><span> 车辆管理</span></a>
                            <ul class="nav nav-pills nav-stacked">
                                <li><a href="/Bus/bus">车辆查找</a></li>
                                <li><a href="/Bus/bus/create">添加车辆</a></li>
                            </ul>
                        </li>

                        <li class="accordion">
                            <a href="#"><i class="glyphicon glyphicon-plus"></i><span> 线路管理</span></a>
                            <ul class="nav nav-pills nav-stacked">
                                <li><a href="/Bus/line/index">线路查找</a></li>
                                <li><a href="/Bus/line/create">添加线路</a></li>
                            </ul>
                        </li>
